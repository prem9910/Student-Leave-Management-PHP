<?php
    ...
    $sql ="SELECT EmpId,Password FROM tblemployees WHERE EmpId=:empid and Password=:password";
                ...
                <form name="signin" method="POST">
                    ...
                    <div class="login-form-body">
                        <div class="form-gp">
                            ...
                            <input type="text" id="exampleInputEmail1" name="empid" autocomplete="off" required>
                            <i class="ti-user"></i>
